 ...
 */
class CRM_Zoomzoom_Upgrader_Base {

  /**
   * @var CRM_Zoomzoom_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Zoomzoom_Upgrader(
        'au.com.agileware.zoomzoom',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Zoomzoom_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Zoomzoom_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
